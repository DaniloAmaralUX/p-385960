  ...
  return (
    <section className="flex justify-between items-center gap-16 px-16 py-24 max-md:flex-col max-md:gap-12 max-md:px-5 max-md:py-16">
      <div className="w-full max-w-[500px] max-md:max-w-full">
        <h1 className="text-5xl font-bold leading-tight mb-6 tracking-tight max-md:text-4xl max-sm:text-3xl">
      ...
      <div className="w-[370px] h-[370px] flex-shrink-0 flex items-center justify-center bg-[#1A1A1A] rounded-full max-lg:w-[300px] max-lg:h-[300px] max-md:w-full max-md:h-[300px] max-md:aspect-square">
        <svg width="180" height="180" viewBox="0 0 180 180" fill="none" xmlns="http://www.w3.org/2000/svg" className="max-md:w-[150px] max-md:h-[150px]">
