...
export function ContactCTA() {
  return (
    <section className="px-16 pb-24 max-md:px-5 max-md:pb-16">
      <div className="bg-[#1E1E1E] border border-[#2D2D2D] rounded-lg p-16 text-center relative overflow-hidden max-md:p-8 max-sm:p-6">
        ...
        <h2 className="text-3xl font-bold mb-4 mt-8 max-sm:text-2xl">Ready to Talk?</h2>
        <p className="text-gray-400 mb-4">
          Our team is here to answer your question about StartP
        </p>
        <a href="#" className="text-[#34C759] block mb-8">Contact Us</a>
        <Button 
          className="bg-[#34C759] hover:bg-[#2db14e] text-white font-semibold px-10 py-3 rounded text-sm max-sm:px-6 max-sm:py-2"
        >
          GET STARTED
        </Button>
      </div>
